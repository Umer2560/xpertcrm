frappe.ui.form.on("CRM Lead", {
	...
	custom_fetch_company(frm) {
		frm.toggle_display(["custom_company_code", "custom_project", "lead_owner", "custom_activation_start_date", "custom_activation_end_date", "status"], !!frm.doc.custom_fetch_company);
		if (frm.doc.custom_fetch_company) {
			frappe.show_alert({
